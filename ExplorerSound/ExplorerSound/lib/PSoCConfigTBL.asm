...
;       Instance name ADCINCVR_pot, Block Name ADC(ASD22)
	db		98h, 90h		;ADCINCVR_pot_bfAtoDcr0       (ASD22CR0)
...
;       Instance name SCBLOCK_inbuff, Block Name SCBLK(ASC23)
	db		9ch, 10h		;SCBLOCK_inbuff_cr0(ASC23CR0)
	db		9dh, 70h		;SCBLOCK_inbuff_cr1(ASC23CR1)
...
;  Global Register values Bank 1
	...
	db		dfh, 4ah		; OscillatorControl_3 register (OSC_CR3)
