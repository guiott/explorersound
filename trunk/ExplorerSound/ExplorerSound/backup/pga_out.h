...
#define PGA_out_G48_0    0x0C
#define PGA_out_G24_0    0x1C
...
#pragma fastcall16 PGA_out_Start
#pragma fastcall16 PGA_out_SetPower
#pragma fastcall16 PGA_out_SetGain
#pragma fastcall16 PGA_out_Stop

//-------------------------------------------------
// Prototypes of the PGA_out API.
//-------------------------------------------------
extern void PGA_out_Start(BYTE bPowerSetting);     // Proxy class 2
extern void PGA_out_SetPower(BYTE bPowerSetting);  // Proxy class 2
extern void PGA_out_SetGain(BYTE bGainSetting);    // Proxy class 2
extern void PGA_out_Stop(void);                    // Proxy class 1

//-------------------------------------------------
// Register Addresses for PGA_out
//-------------------------------------------------

#pragma ioport  PGA_out_GAIN_CR0:   0x079
BYTE            PGA_out_GAIN_CR0;
#pragma ioport  PGA_out_GAIN_CR1:   0x07a
BYTE            PGA_out_GAIN_CR1;
#pragma ioport  PGA_out_GAIN_CR2:   0x07b
BYTE            PGA_out_GAIN_CR2;
#pragma ioport  PGA_out_GAIN_CR3:   0x078
BYTE            PGA_out_GAIN_CR3;


// end of file PGA_out.h
