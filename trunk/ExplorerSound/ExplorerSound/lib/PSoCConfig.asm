...
export LoadConfig_explorersound
export _LoadConfig_explorersound
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_explorersound
	lcall	LoadConfigTBL_explorersound_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration explorersound
;
;    Load configuration registers for explorersound.
...
;               CUR_PP
;
_LoadConfig_explorersound:
 LoadConfig_explorersound:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_explorersound_Bank0
    mov     X, <LoadConfigTBL_explorersound_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_explorersound_Bank1
    mov     X, <LoadConfigTBL_explorersound_Bank1
